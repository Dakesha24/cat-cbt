            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow border-0 py-1" aria-labelledby="profileDropdown"
                        ...
                        <li><a class="dropdown-item d-flex align-items-center gap-2 py-2" href="<?= base_url('guru/profil') ?>">
            ...
            <ul class="nav flex-column" style="list-style:none; padding:0; margin:0">
                ...
                <li class="nav-item">
                    <a href="<?= base_url('guru/dashboard') ?>"
                        class="nav-link <?= current_url() == base_url('guru/dashboard') ? 'active' : '' ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link sidebar-toggle" data-bs-toggle="collapse" href="#collapseGuruBank" role="button">
                        <i class="bi bi-layers"></i>
                        <span>Bank & Metadata</span>
                        <i class="bi bi-chevron-down toggle-icon"></i>
                    </a>
                    <div class="collapse <?= (strpos(current_url(), 'guru/bank-soal') !== false || strpos(current_url(), 'guru/variabel') !== false || strpos(current_url(), 'guru/indikator') !== false || strpos(current_url(), 'guru/materi') !== false || strpos(current_url(), 'guru/jenis-ujian') !== false) ? 'show' : '' ?>"
                        id="collapseGuruBank">
                        <ul class="nav flex-column submenu">
                            <li class="nav-item">
                                <a href="<?= base_url('guru/bank-soal') ?>"
                                    class="nav-link <?= (strpos(current_url(), 'guru/bank-soal') !== false) ? 'active' : '' ?>">
                                    <i class="bi bi-database"></i>Bank Soal
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?= base_url('guru/jenis-ujian') ?>"
                                    class="nav-link <?= (strpos(current_url(), 'guru/jenis-ujian') !== false) ? 'active' : '' ?>">
                                    <i class="bi bi-journal-text"></i>Mata Pelajaran
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?= base_url('guru/variabel') ?>"
                                    class="nav-link <?= (strpos(current_url(), 'guru/variabel') !== false) ? 'active' : '' ?>">
                                    <i class="bi bi-diagram-3"></i>Variabel
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?= base_url('guru/indikator') ?>"
                                    class="nav-link <?= (strpos(current_url(), 'guru/indikator') !== false) ? 'active' : '' ?>">
                                    <i class="bi bi-list-check"></i>Indikator
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?= base_url('guru/materi') ?>"
                                    class="nav-link <?= (strpos(current_url(), 'guru/materi') !== false) ? 'active' : '' ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link sidebar-toggle" data-bs-toggle="collapse" href="#collapseGuruUjian" role="button">
                        ...
                        <ul class="nav flex-column submenu">
                            <li class="nav-item">
                                <a href="<?= base_url('guru/ujian') ?>"
                                    class="nav-link <?= (strpos(current_url(), 'guru/ujian') !== false) ? 'active' : '' ?>">
                                    <i class="bi bi-file-earmark-text"></i>Daftar Ujian
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?= base_url('guru/jadwal-ujian') ?>"
                                    class="nav-link <?= (strpos(current_url(), 'guru/jadwal-ujian') !== false) ? 'active' : '' ?>">
                ...
                <li class="nav-item">
                    <a href="<?= base_url('guru/pengumuman') ?>"
                        class="nav-link <?= (strpos(current_url(), 'guru/pengumuman') !== false) ? 'active' : '' ?>">
