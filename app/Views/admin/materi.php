            ...
            <?php if (empty($materi)): ?>
              <tr><td colspan="5">
                <div class="empty-state">
                  ...
                  <p>Tambahkan materi pertama untuk memulai</p>
                </div>
              </td></tr>
            <?php else: ?>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex gap-1">
                      ...
                      <a href="<?= base_url('admin/materi/hapus/' . $m['materi_id']) ?>"
...
<div class="modal fade" id="modalTambah" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content border-0 shadow">
      ...
      <form method="post" action="<?= base_url('admin/materi/tambah') ?>">
...
function editMateri(id, nama, deskripsi) {
  document.getElementById('formEdit').action = '<?= base_url('admin/materi/edit/') ?>' + id;
