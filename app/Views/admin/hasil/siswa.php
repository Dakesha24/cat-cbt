...
<div class="container-fluid px-3 px-md-4">
  ...
  <div class="hs-head">
    ...
    <div class="d-flex gap-2 flex-wrap">
      ...
      <a href="<?= base_url('admin/hasil-ujian') ?>" class="hs-btn" style="border-color:#d1d5db;color:#374151;border-radius:0;text-decoration:none;display:inline-flex;align-items:center;gap:.3rem">
        ...
        <tbody>
          ...
          <tr data-status="<?= $siswa['status'] ?>"
            ...
            <td>
              <div class="hs-act">
                <?php if ($siswa['status'] === 'selesai'): ?>
                  <a href="<?= base_url($isCbt ? 'admin/hasil-ujian/percobaan/' : 'admin/hasil-ujian/detail/') . $siswa['peserta_ujian_id'] ?>" class="hs-btn hs-btn-view">
...
function doDelete(id) { window.location.href = '<?= base_url('admin/hasil-ujian/hapus/') ?>' + id; }
function doReset(id)  { window.location.href = '<?= base_url('admin/hasil-ujian/reset/') ?>' + id; }
</script>
