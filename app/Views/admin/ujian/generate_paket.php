...
<div class="container-fluid py-4">
  <div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="<?= base_url('admin/ujian/' . $ujian['id_ujian'] . '/bank') ?>" class="btn btn-outline-secondary"><i class="bi bi-arrow-left me-1"></i>Kembali</a>
  </div>
    ...
    <div class="col-md-4">
      <div class="card border-info">
        <div class="card-body text-center">
          <h3 class="text-info mb-0"><?= count($assignedBanks) ?></h3>
          <small>Bank Sumber Tunggal</small>
        </div>
      </div>
    </div>
    <div class="col-md-4">
      <div class="card border-success">
        <div class="card-body text-center">
          <h3 class="text-success mb-0"><?= $totalSoal ?></h3>
          <small>Total Soal Tersedia</small>
        </div>
      </div>
    </div>
    <div class="col-md-4">
      <div class="card border-warning">
        <div class="card-body text-center">
          <h3 class="text-warning mb-0"><?= count($paketList) ?></h3>
          <small>Paket Sudah Ada</small>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="card shadow-sm">
    ...
    <div class="card-body">
      <?php if (empty($assignedBanks)): ?>
        <div class="alert alert-warning"><i class="bi bi-exclamation-triangle me-2"></i>Belum ada bank yang di-assign. <a href="<?= base_url('admin/ujian/' . $ujian['id_ujian'] . '/bank') ?>">Assign bank dulu</a>.</div>
      <?php else: ?>
        <form method="post" action="<?= base_url('admin/ujian/' . $ujian['id_ujian'] . '/generate-paket/proses') ?>">
          <div class="row g-3">
            <div class="col-md-4">
              ...
              <div class="form-text">Berapa set paket yang berbeda?</div>
            </div>
            <div class="col-md-4">
              ...
              <div class="form-text">Jumlah soal dalam satu paket</div>
            </div>
            <div class="col-md-4 d-flex align-items-end">
              <div class="w-100">
                <div class="alert alert-info py-2 mb-2"><small>Validasi: <strong>Y &lt; N</strong>. Overlap antar paket diperbolehkan.</small></div>
