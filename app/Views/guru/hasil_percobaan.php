...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?= base_url('guru/hasil-ujian/siswa/' . $peserta['jadwal_id']) ?>" class="btn btn-outline-secondary">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        <a href="<?= base_url('guru/hasil-ujian/detail/' . $peserta['peserta_ujian_id']) . '?attempt_id=' . $attempt['attempt_id'] ?>" class="btn btn-info">
                                            Detail
                                        </a>
                                        <a href="<?= base_url('guru/hasil-ujian/download-excel-html/' . $peserta['peserta_ujian_id']) . '?attempt_id=' . $attempt['attempt_id'] ?>" class="btn btn-success">
                                            Excel
                                        </a>
                                        <a href="<?= base_url('guru/hasil-ujian/download-pdf-html/' . $peserta['peserta_ujian_id']) . '?attempt_id=' . $attempt['attempt_id'] ?>" class="btn btn-danger" target="_blank">
                                            PDF
                                        </a>
                                    </div>
                                </td>
