...
<div class="container-fluid px-3 px-md-4">
  ...
  <div class="hs-head">
    ...
    <a href="<?= base_url('guru/hasil-ujian/siswa/' . $peserta['jadwal_id']) ?>" class="hs-btn hs-btn-secondary">
        ...
        <tbody>
          <?php foreach ($attempts as $idx => $attempt): ?>
            <tr>
              ...
              <td><span class="hs-mono" style="font-size:.82rem"><?= esc($attempt['waktu_mulai_format']) ?></span></td>
              <td><span class="hs-mono" style="font-size:.82rem"><?= esc($attempt['waktu_selesai_format']) ?></span></td>
              <td><span class="hs-mono"><?= esc($attempt['durasi_format']) ?></span></td>
              <td>
              ...
              <td>
                <div class="hs-act">
                  <a href="<?= base_url('guru/hasil-ujian/detail/' . $peserta['peserta_ujian_id']) . '?attempt_id=' . $attempt['attempt_id'] ?>"
                     class="hs-btn hs-btn-primary">
                    <i class="fas fa-eye"></i>Detail
                  </a>
                  <a href="<?= base_url('guru/hasil-ujian/download-excel-html/' . $peserta['peserta_ujian_id']) . '?attempt_id=' . $attempt['attempt_id'] ?>"
                     class="hs-btn hs-btn-success">
                    <i class="fas fa-file-excel"></i>Excel
                  </a>
                  <a href="<?= base_url('guru/hasil-ujian/download-pdf-html/' . $peserta['peserta_ujian_id']) . '?attempt_id=' . $attempt['attempt_id'] ?>"
