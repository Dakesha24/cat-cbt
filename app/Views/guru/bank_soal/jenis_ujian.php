...
<div class="container-fluid py-4">
  ...
  <div class="d-flex flex-wrap justify-content-between align-items-start mb-4">
    ...
    <a href="<?= base_url('guru/bank-soal/kategori/' . urlencode($kategori)) ?>" class="btn btn-outline-secondary btn-sm mt-1">
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex gap-1">
                      ...
                      <a href="<?= base_url('guru/bank-soal/hapus/' . $ujian['bank_ujian_id']) ?>"
