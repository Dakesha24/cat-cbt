  ...
  <div class="d-flex flex-wrap justify-content-between align-items-start mb-4">
    <div>
      <nav aria-label="breadcrumb" class="mb-1">
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="<?= base_url('guru/bank-soal') ?>"><i class="bi bi-journals me-1"></i>Bank Soal</a></li>
          <li class="breadcrumb-item"><a href="<?= base_url('guru/bank-soal/kategori/' . urlencode($kategori)) ?>"><?= $kategori === 'umum' ? 'Umum' : 'Kelas ' . esc($kategori) ?></a></li>
          <li class="breadcrumb-item"><a href="<?= base_url('guru/bank-soal/kategori/' . urlencode($kategori) . '/jenis-ujian/' . $bankUjian['jenis_ujian_id']) ?>"><?= esc($bankUjian['nama_jenis']) ?></a></li>
    ...
    <div class="d-flex gap-2 mt-1">
      <a href="<?= base_url('guru/bank-soal/kategori/' . urlencode($kategori) . '/jenis-ujian/' . $bankUjian['jenis_ujian_id']) ?>" class="btn btn-outline-secondary btn-sm">
