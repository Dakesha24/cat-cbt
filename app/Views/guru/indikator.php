        ...
        <table class="table mb-0">
          ...
          <tbody>
            <?php if (empty($indikator)): ?>
              <tr><td colspan="5"><div class="empty-state"><i class="bi bi-inbox"></i><h6>Belum ada indikator</h6><p>Tambahkan indikator pertama untuk memulai</p></div></td></tr>
            <?php else: ?>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex gap-1">
                      ...
                      <a href="<?= base_url('guru/indikator/hapus/' . $i['indikator_id']) ?>"
...
<div class="modal fade" id="modalTambah" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content border-0 shadow">
      ...
      <form method="post" action="<?= base_url('guru/indikator/tambah') ?>">
...
function editIndikator(id, variabelId, nama, deskripsi) {
  document.getElementById('formEdit').action = '<?= base_url('guru/indikator/edit/') ?>' + id;
